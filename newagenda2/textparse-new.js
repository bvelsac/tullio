	 	 ...
	 	 htmlCode = htmlCode + "<TR>";
			...
			for (i=0; i<modelLength; i++) {
				...
				if (spec[i][1] == 'tags' ) {
					...
					// loop through the members of government and gather the JSON data and the XML tags
				
					
					htmlCode = htmlCode + '[';
					var listGov = agendaArray1[c][spec[i][2]-1];
					
					for (var xc = 0; xc < listGov.length; xc++) {
						var assArr = '{&#34;id&#34;:&#34;' + listGov[xc] + '&#34;,&#34;name&#34;:&#34;' + listGov[xc] +'&#34;}';
						htmlCode = htmlCode + assArr;
						if (xc+1 != listGov.length) {
							htmlCode = htmlCode + ",";
						}
					}
					htmlCode = htmlCode + "]'>";
