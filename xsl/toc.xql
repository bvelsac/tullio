...
(: return   $output :)
return transform:transform($output, "../xsl/toc.xsl", <parameters><param name="numbering" value="{$numbering}"/><param name="type" value="{$type}"/><param name="firstLang" value="{$firstLang}"/></parameters>)
