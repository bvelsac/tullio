...
CKEDITOR.addTemplates('default',
	...
	templates:[
	{title:'Stemming NL',image:'template1.gif',description:'One main image with a title and text that surround the image.',html:'<p>Tot stemming wordt overgegaan.</p><p>UITSLAG VAN DE STEMMING</p><p><span style="font-weight:bold; color:red">XX</span> leden zijn aanwezig</p><p><span style="font-weight:bold; color:red">XX</span> antwoorden ja.</p><p><span style="font-weight:bold; color:red">XX</span> antwoorden neen.</p><p><span style="font-weight:bold; color:red">XX</span> onthouden zich.</p>'},
